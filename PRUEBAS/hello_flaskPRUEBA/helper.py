#archivo python donde se guardan datos para recuperarlos desde la clase principal
...
ingredients = {1: ["1 pad of butter", "1 Egg", "A pinch of salt"], 2: [
    "1 pad of salted butter", "1 slice of bread"]}
...
#funcion que añade ingredientes recibiendo un id y un texto por parametro
...
#funcion que añade instrucciones recibiendo un id y un texto por parametro
